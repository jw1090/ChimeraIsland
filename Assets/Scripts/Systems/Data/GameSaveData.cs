...
public class GameSaveData
{
    ...
    public GameSaveData(GlobalData globalData, List<HabitatData> habitatData, List<FacilityData> facilityData, List<ChimeraData> chimeraData, TutorialCompletionData tutorialCompletionData, SettingsData settingsData)
    {
